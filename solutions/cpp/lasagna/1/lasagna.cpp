...
int remainingOvenTime(int actualMinutesInOven) {
    ...
    int remaining_oven_time = ovenTime() - actualMinutesInOven ;
    
    return remaining_oven_time;
}
...
int preparationTime(int numberOfLayers) {
    ...
    // `numberOfLayers`.
    int preparation_time{2};
    int total_preparation_time  = preparation_time * numberOfLayers ;
...
int elapsedTime(int numberOfLayers, int actualMinutesInOven) {
    ...
    int elapsed_time  = preparationTime(numberOfLayers) + actualMinutesInOven ;
