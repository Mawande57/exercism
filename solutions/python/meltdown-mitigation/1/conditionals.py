...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    if percantage_value >= 80:
        return "green"
    elif percantage_value < 80 and percantage_value >= 60 :
        return "orange"
    elif percantage_value < 60 and percantage_value >= 30:
        return "red"
    else:
        return "black"
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    temp_nutron = temperature * neutrons_produced_per_second
    percent = (temp_nutron / threshold)  * 100
    if percent < 90:
        return "LOW"
