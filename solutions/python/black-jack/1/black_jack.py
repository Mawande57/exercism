...
def value_of_ace(card_one, card_two):
    ...
    value_cards = value_of_card(card_one) + value_of_card(card_two)
    if card_one == 'A' or card_two == 'A':
        return 1
    elif 0 < value_cards <= 10 :
        return 11
    elif 10<value_cards <=20:
        return 1
...
def is_blackjack(card_one, card_two):
    ...
    if card_one == 'A' and card_two in ten_card :
        return True
    elif card_two == 'A' and card_one in ten_card :
        return True
    else:
        return False
